...
<head>
    ...
    <title>Halaman Home | Buah Tangan</title>
</head>
<body>
<div class="container-fluid ">
        <div class="d-flex justify-content-between" id="navBar">
            ...
            <div class=" align-self-center" id="menu-item">
                <ul>
                    <li><a href="halaman_customer.php" id="active">Home</a></li>
...
<div id="content" class="d-flex justify-content-around">
        <img src="assets/image/img-frm1.png" alt="" id="contentImg1" data-aos="fade-right">
        <img src="assets/image/img-frm.png" alt="" id="contentImg2" data-aos="fade-left">
    </div>
</main>
<footer>
