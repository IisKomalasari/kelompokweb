...
<head>
    ...
    <title>Halaman Data Pemesanan | MarketPlace Buah Tangan </title>
</head>
<body>
    <?php
    //tambahkan dbconnect
...
<div class="container">
                <div class="card mt-3">
                    <div class="card-header text-center">
                        <h3>Halaman Pengelolaan Data Pemesanan</h3>
                        <?php
                        //tambahkan dbconnect
                        include('koneksi.php');
                    ...
                    <div class="card-body">
                        <a href="tambah_datapemesanan.php" class="btn btn-primary">Tambah Data Pemesanan</a>
                    </div>
                    <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr align="center">
                                    ...
                                    <td><?php echo $row['banyakproduk']; ?></td>
                                    <td><?php echo $row['totalhargaproduk']; ?></td>
                                    <td><?php echo $row['imageproduk']; ?></td>
                                    <td>
                                        <p class="d-grid gap-2 col-15 mx-auto">
                                        <a href="editform_datapemesanan.php?kd_pemesanan=<?php echo $row['kd_pemesanan']; ?>" class="btn btn-primary btn-sm" role="button">Edit</a>
                                        <a href="delete_datapemesanan.php?kd_pemesanan=<?php echo $row['kd_pemesanan']; ?>" onclick="return confirm('Anda yakin ingin hapus')" class="btn btn-danger btn-sm" role="button">Delete</a>
                                        </p>
                                    </td>
                                </tr>
                            <?php
