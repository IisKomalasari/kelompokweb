...
<head>
    ...
    <title>Halaman Cart | Buah Tangan</title>
</head>
...
<div class="container-fluid ">
        <div class="d-flex justify-content-between" id="navBar">
            ...
            <div class=" align-self-center" id="menu-item">
                <ul>
                    ...
                    <li><a href="halaman_cart.php" id="active">Cart(0) <i class="fa-solid fa-cart-shopping"></i></i></a></li>
    ...
    <div id="content" class="row" style="margin-top: 20px; ">
            <div class="col">
                <img class="img-fluid" id="ImgProdk2" src="assets/img-prdk2.png" style="width: auto;">
            </div>
            <div class="col">
                <img class="img-fluid" id="imgProd2" src="assets/img-ds2.png" style="width: auto;">
            </div>
        </div>
        <button onclick="haloGoblog('Masukan Keranjang');" type="button" class="btnProd btnProd-3" style="margin-left: 840px; margin-top:3px; margin-bottom: 3px;" href="#">Pre Order</button>
    </div>
    </section>
<footer>
