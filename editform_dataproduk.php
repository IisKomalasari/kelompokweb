...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Edit Produk</h1>
<?php
...
<div class="card-body">
<form role="form" action="edit_dataproduk.php" method="get" enctype="multipart/form-data" >
...
<input type="hidden" name="id_produk" value="<?php echo $row['id_produk']; ?>">
    <div class="mb-3">
      ...
      <select type="text" class="form-control" name="namaproduk" id="namaproduk" value="<?= $row['namaproduk']; ?>">
	...
	<div class="form-group mt-3">
         ...
         <input type="number" name="hargaproduk" class="input-control" value="<?php echo $row['hargaproduk']; ?>">
     </div>
	 <div class="mb-3">
      <label for="statusproduk" class="form-label"> Status Produk</label>
      <select type="text" class="form-control" name="statusproduk" id="statusproduk" value="<?= $row['statusproduk']; ?>">
	...
	<label for="stokproduk" class="form-label"> Status Produk</label>
      <select type="text" class="form-control" name="stokproduk" id="stokproduk" value="<?= $row['stokproduk']; ?>">
    ...
    <input type="file" name="imageproduk">
    </div>
